...
import { createRuntimeRateLimitGuard } from './middleware/rate-limit.js';
...
import { createApiError, isApiError, writeJSON } from './response.js';
  ...
  return {
    ...
    handler: async (req, res) => {
      ...
      try {
        ...
        if (await options.handleLegacyRoute(context)) {
          return;
        }
